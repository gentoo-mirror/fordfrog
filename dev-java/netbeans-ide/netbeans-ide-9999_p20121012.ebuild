...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2012-10-12_00-02-25/zip/netbeans-trunk-nightly-201210120002-src.zip"
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/499CC182A6E6D780DFE0089C849691F88C2A893C-exechlp-1.0.zip
	http://hg.netbeans.org/binaries/5B067612E34C3694DAB31CA3B07BB94150DA7E13-glassfish-tooling-sdk-0.3-b012.jar
	...
	http://hg.netbeans.org/binaries/166B947DDA23A342D34AA42BE1A25957A83129B7-nashorn.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/499CC182A6E6D780DFE0089C849691F88C2A893C-exechlp-1.0.zip dlight.nativeexecution/external/exechlp-1.0.zip || die
	ln -s "${DISTDIR}"/5B067612E34C3694DAB31CA3B07BB94150DA7E13-glassfish-tooling-sdk-0.3-b012.jar libs.glassfish.sdk/external/glassfish-tooling-sdk-0.3-b012.jar || die
	...
	ln -s "${DISTDIR}"/166B947DDA23A342D34AA42BE1A25957A83129B7-nashorn.jar libs.nashorn/external/nashorn.jar || die
