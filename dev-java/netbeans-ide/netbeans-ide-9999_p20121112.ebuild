...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2012-11-12_00-01-24/zip/netbeans-trunk-nightly-201211120001-src.zip"
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/DCA79ACCDA55679B141030CD248B0A022F8F5253-exechlp-1.0.zip
	http://hg.netbeans.org/binaries/6E54F93704B951616118F24990D1245A2C5D408B-glassfish-tooling-sdk-0.3-b030.jar
	...
	http://hg.netbeans.org/binaries/711D200052C8E0C0FA945E8B71B16AB50291EC5A-js-corestubs.zip
	http://hg.netbeans.org/binaries/50299B4075C4EF729D784DD59949E810355199F2-js-domstubs.zip
	http://hg.netbeans.org/binaries/CFDA1AA05A7B48B0C42837886DDC5710B1A6F1C5-js-reststubs.zip
	http://hg.netbeans.org/binaries/2E07375E5CA3A452472F0E87FB33F243F7A5C08C-libpam4j-1.1.jar
	http://hg.netbeans.org/binaries/FCB22A648FC35AD0E492ACC5DAC9B2146735D6CE-nashorn.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/DCA79ACCDA55679B141030CD248B0A022F8F5253-exechlp-1.0.zip dlight.nativeexecution/external/exechlp-1.0.zip || die
	ln -s "${DISTDIR}"/6E54F93704B951616118F24990D1245A2C5D408B-glassfish-tooling-sdk-0.3-b030.jar libs.glassfish.sdk/external/glassfish-tooling-sdk-0.3-b030.jar || die
	...
	ln -s "${DISTDIR}"/711D200052C8E0C0FA945E8B71B16AB50291EC5A-js-corestubs.zip javascript2.editor/external/js-corestubs.zip || die
	ln -s "${DISTDIR}"/50299B4075C4EF729D784DD59949E810355199F2-js-domstubs.zip javascript2.editor/external/js-domstubs.zip || die
	ln -s "${DISTDIR}"/CFDA1AA05A7B48B0C42837886DDC5710B1A6F1C5-js-reststubs.zip javascript2.editor/external/js-reststubs.zip || die
	ln -s "${DISTDIR}"/2E07375E5CA3A452472F0E87FB33F243F7A5C08C-libpam4j-1.1.jar extexecution.impl/external/libpam4j-1.1.jar || die
	ln -s "${DISTDIR}"/FCB22A648FC35AD0E492ACC5DAC9B2146735D6CE-nashorn.jar libs.nashorn/external/nashorn.jar || die
