...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2012-04-09_04-00-16/zip/netbeans-trunk-nightly-201204090400-src.zip"
SRC_URI="${SOURCE_URL}
	http://dev.gentoo.org/~fordfrog/distfiles/netbeans-9999-r3-build.xml.patch.bz2
	...
	http://hg.netbeans.org/binaries/90FF0731FAFB05C01FEE4F2247140D56E9C30A3B-lucene-core-3.5.0.jar
	...
	http://hg.netbeans.org/binaries/299144A066A7E2965ACB1A30D71F4D1E6C0FC061-org.tmatesoft.svnkit_1.7.4.rc1_t20120321_0030.jar
	...
	http://hg.netbeans.org/binaries/69229EDC4C10A6B5752BA517F624544CE1F69721-sqljet-1.1.0-SNAPSHOT_r1197_v20120313_1735.jar
	http://hg.netbeans.org/binaries/CD5B5996B46CB8D96C8F0F89A7A734B3C01F3DF7-tomcat-webserver-3.2.jar
	http://hg.netbeans.org/binaries/E1E307B031161B5D5FB7E4CB2FADE454CCF2506B-trilead-ssh2-1.0.0-build214.jar
...
#	dev-java/lucene:3.5 we do not have slot 3.5 yet
...
src_unpack() {
	...
	unpack netbeans-9999-r3-build.xml.patch.bz2
	...
	ln -s "${DISTDIR}"/299144A066A7E2965ACB1A30D71F4D1E6C0FC061-org.tmatesoft.svnkit_1.7.4.rc1_t20120321_0030.jar libs.svnClientAdapter.svnkit/external/org.tmatesoft.svnkit_1.7.4.rc1_t20120321_0030.jar || die
	...
	ln -s "${DISTDIR}"/69229EDC4C10A6B5752BA517F624544CE1F69721-sqljet-1.1.0-SNAPSHOT_r1197_v20120313_1735.jar libs.svnClientAdapter.svnkit/external/sqljet-1.1.0-SNAPSHOT_r1197_v20120313_1735.jar || die
	...
	ln -s "${DISTDIR}"/E1E307B031161B5D5FB7E4CB2FADE454CCF2506B-trilead-ssh2-1.0.0-build214.jar libs.svnClientAdapter.svnkit/external/trilead-ssh2-1.0.0-build214.jar || die
...
src_prepare() {
	...
	epatch netbeans-9999-r3-build.xml.patch
