...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/949787055E53B7698D8EB282154CCF0901E07C7B-exechlp-1.0.zip
	http://hg.netbeans.org/binaries/246681FB4550076A8E8C7495C5AEE01F2670C347-glassfish-tooling-sdk-0.3-b029.jar
	...
	http://hg.netbeans.org/binaries/3D728E9D8B158991BA33B3B2D1F5D2E972672F77-js-corestubs.zip
	http://hg.netbeans.org/binaries/E3C5BF18FD05065164B3D0F6659C10D677636860-js-domstubs.zip
	http://hg.netbeans.org/binaries/BDFF9815D4D567CF7C1E92D2FCFDEBA32D578048-js-reststubs.zip
	http://hg.netbeans.org/binaries/2E07375E5CA3A452472F0E87FB33F243F7A5C08C-libpam4j-1.1.jar
	http://hg.netbeans.org/binaries/BE6B6B0C6BA00B58EF95BF4BED8CC9FC2C09FAFF-jre-8-ea-bin-b57-linux-i586-31_oct_2012_nashorn.tar.gz
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/949787055E53B7698D8EB282154CCF0901E07C7B-exechlp-1.0.zip dlight.nativeexecution/external/exechlp-1.0.zip || die
	ln -s "${DISTDIR}"/246681FB4550076A8E8C7495C5AEE01F2670C347-glassfish-tooling-sdk-0.3-b029.jar libs.glassfish.sdk/external/glassfish-tooling-sdk-0.3-b029.jar || die
	...
	ln -s "${DISTDIR}"/3D728E9D8B158991BA33B3B2D1F5D2E972672F77-js-corestubs.zip javascript2.editor/external/js-corestubs.zip || die
	ln -s "${DISTDIR}"/E3C5BF18FD05065164B3D0F6659C10D677636860-js-domstubs.zip javascript2.editor/external/js-domstubs.zip || die
	ln -s "${DISTDIR}"/BDFF9815D4D567CF7C1E92D2FCFDEBA32D578048-js-reststubs.zip javascript2.editor/external/js-reststubs.zip || die
	ln -s "${DISTDIR}"/2E07375E5CA3A452472F0E87FB33F243F7A5C08C-libpam4j-1.1.jar extexecution.impl/external/libpam4j-1.1.jar || die
	ln -s "${DISTDIR}"/BE6B6B0C6BA00B58EF95BF4BED8CC9FC2C09FAFF-jre-8-ea-bin-b57-linux-i586-31_oct_2012_nashorn.tar.gz libs.nashorn/external/jre-8-ea-bin-b57-linux-i586-31_oct_2012_nashorn.tar.gz || die
