...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/BDFC25B87D1A034FACBC13133406BAB416814525-antlr3.3-runtime.jar
	...
	http://hg.netbeans.org/binaries/23EF7B58C74CC9CFA6956553C78F69AC71651888-css3-spec.zip
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/BDFC25B87D1A034FACBC13133406BAB416814525-antlr3.3-runtime.jar css.lib/external/antlr3.3-runtime.jar || die
	...
	ln -s "${DISTDIR}"/23EF7B58C74CC9CFA6956553C78F69AC71651888-css3-spec.zip css.editor/external/css3-spec.zip || die
...
src_prepare() {
	...
	#java-pkg_jar-from --into css.lib/external antlr-3 antlr3.jar antlr3.3-runtime.jar
	java-pkg_jar-from --into css.editor/external flute flute.jar flute-1.3.jar
	java-pkg_jar-from --into css.editor/external sac sac.jar sac-1.3.jar
