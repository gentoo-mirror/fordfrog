...
src_unpack() {
	...
	ln -s "${DISTDIR}"/34E70691382D67EE5C84EF207FB8D3784594BA2C-org.eclipse.jgit-1.0.0.201106090707-r.jar libs.git/external/org.eclipse.jgit-1.0.0.201106090707-r.jar || die
