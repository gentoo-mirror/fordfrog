...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2012-08-29_00-01-28/zip/netbeans-trunk-nightly-201208290001-src.zip"
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/4DE6B891C82002D6EA3BAAB19274852FADA47E5C-glassfish-tooling-sdk-0.2-SNAPSHOT.jar
	...
	http://hg.netbeans.org/binaries/80349CA1DDF7FB293A775906931B8A4208EBE24F-nashorn.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/4DE6B891C82002D6EA3BAAB19274852FADA47E5C-glassfish-tooling-sdk-0.2-SNAPSHOT.jar libs.glassfish.sdk/external/glassfish-tooling-sdk-0.2-SNAPSHOT.jar || die
	...
	ln -s "${DISTDIR}"/80349CA1DDF7FB293A775906931B8A4208EBE24F-nashorn.jar libs.nashorn/external/nashorn.jar || die
