...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2013-07-02_23-00-49/zip/netbeans-trunk-nightly-201307022300-src.zip"
SRC_URI="${SOURCE_URL}
	http://dev.gentoo.org/~fordfrog/distfiles/netbeans-9999-r9-build.xml.patch.bz2
	...
	http://hg.netbeans.org/binaries/77B15258E01216226E00DFA2ADD9C0F6D4E1B7C1-glassfish-tooling-sdk-0.3-b047.jar
	...
	http://hg.netbeans.org/binaries/90813273BB5FECF7BDAF5478F63666C444421BA0-nashorn-02f810c26ff9-patched.jar
...
src_unpack() {
	...
	unpack netbeans-9999-r9-build.xml.patch.bz2
	...
	ln -s "${DISTDIR}"/77B15258E01216226E00DFA2ADD9C0F6D4E1B7C1-glassfish-tooling-sdk-0.3-b047.jar libs.glassfish.sdk/external/glassfish-tooling-sdk-0.3-b047.jar || die
	...
	ln -s "${DISTDIR}"/90813273BB5FECF7BDAF5478F63666C444421BA0-nashorn-02f810c26ff9-patched.jar libs.nashorn/external/nashorn-02f810c26ff9-patched.jar || die
...
src_prepare() {
	...
	epatch netbeans-9999-r9-build.xml.patch
