...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2013-07-21_23-00-49/zip/netbeans-trunk-nightly-201307212300-src.zip"
SRC_URI="${SOURCE_URL}
	http://dev.gentoo.org/~fordfrog/distfiles/netbeans-9999-r10-build.xml.patch.bz2
	...
	http://hg.netbeans.org/binaries/F76FF64F941E71395A0E07CAD82EE44310EEA842-commons-net-3.2.jar
	...
	http://hg.netbeans.org/binaries/886018BFD299115709FB351D28D9C1F5A2C6F5FD-exechlp-1.0.zip
	http://hg.netbeans.org/binaries/5EEAAC41164FEBCB79C73BEBD678A7B6C10C3E80-freemarker-2.3.19.jar
	http://hg.netbeans.org/binaries/D32271557B039747767F6321ED0B38B0C4458DDE-glassfish-tooling-sdk-0.3-b050.jar
	...
	http://hg.netbeans.org/binaries/7AEA1C943E8EC2E2957B419C1E3D2050421066D5-js-corestubs.zip
	http://hg.netbeans.org/binaries/BE937A7E45748EE9E3EC30B54481DEA6DDB28901-js-domstubs.zip
	http://hg.netbeans.org/binaries/DA3CAC9F2867D6C61BB0E03A69658713332E12AB-js-reststubs.zip
	http://hg.netbeans.org/binaries/10EED0A1D831F8EC5FBD38F7C49352017D76296D-jsch.agentproxy.core-0.0.5.jar
	http://hg.netbeans.org/binaries/9782615745DE80421D805240541E6B4F1E6A797A-jsch.agentproxy.sshagent-0.0.5.jar
	http://hg.netbeans.org/binaries/A96C3EAE7CA812AD3EAB07A0ECABA0469AAAE6FD-jsch.agentproxy.pageant-0.0.5.jar
	http://hg.netbeans.org/binaries/8C05A1E3FE1BD4DC07F12E7BCF197118B29FB58E-jsch.agentproxy.usocket-nc-0.0.5.jar
	http://hg.netbeans.org/binaries/F3885B903DC60BFD657520250788137D318B7B3C-jsch.agentproxy.usocket-jna-0.0.5.jar
	http://hg.netbeans.org/binaries/2E07375E5CA3A452472F0E87FB33F243F7A5C08C-libpam4j-1.1.jar
	http://hg.netbeans.org/binaries/3B181A2D228F92CA0531D3AB03E759D742B913D5-nashorn-02f810c26ff9-patched.jar
	...
	http://hg.netbeans.org/binaries/0CB932CDAD1898C52A0B11FFF854BB3CD8C46A30-org.eclipse.mylyn.wikitext.confluence.core_1.7.1.v20120725-0100.jar
	http://hg.netbeans.org/binaries/AEA3D94B08D44DEB6556DCC93F7568D6C2E8A686-org.eclipse.mylyn.wikitext.core_1.7.1.v20120725-0100.jar
	http://hg.netbeans.org/binaries/3B144D023541891D063C1DACA5980FA56918191B-org.eclipse.mylyn.wikitext.textile.core_1.7.1.v20120725-0100.jar
...
src_unpack() {
	...
	unpack netbeans-9999-r10-build.xml.patch.bz2
	...
	ln -s "${DISTDIR}"/F76FF64F941E71395A0E07CAD82EE44310EEA842-commons-net-3.2.jar libs.commons_net/external/commons-net-3.2.jar || die
	...
	ln -s "${DISTDIR}"/886018BFD299115709FB351D28D9C1F5A2C6F5FD-exechlp-1.0.zip dlight.nativeexecution/external/exechlp-1.0.zip || die
	...
	ln -s "${DISTDIR}"/D32271557B039747767F6321ED0B38B0C4458DDE-glassfish-tooling-sdk-0.3-b050.jar libs.glassfish.sdk/external/glassfish-tooling-sdk-0.3-b050.jar || die
	...
	ln -s "${DISTDIR}"/7AEA1C943E8EC2E2957B419C1E3D2050421066D5-js-corestubs.zip javascript2.editor/external/js-corestubs.zip || die
	ln -s "${DISTDIR}"/BE937A7E45748EE9E3EC30B54481DEA6DDB28901-js-domstubs.zip javascript2.editor/external/js-domstubs.zip || die
	ln -s "${DISTDIR}"/DA3CAC9F2867D6C61BB0E03A69658713332E12AB-js-reststubs.zip javascript2.editor/external/js-reststubs.zip || die
	ln -s "${DISTDIR}"/10EED0A1D831F8EC5FBD38F7C49352017D76296D-jsch.agentproxy.core-0.0.5.jar libs.jsch.agentproxy/external/jsch.agentproxy.core-0.0.5.jar || die
	ln -s "${DISTDIR}"/9782615745DE80421D805240541E6B4F1E6A797A-jsch.agentproxy.sshagent-0.0.5.jar libs.jsch.agentproxy/external/jsch.agentproxy.sshagent-0.0.5.jar || die
	ln -s "${DISTDIR}"/A96C3EAE7CA812AD3EAB07A0ECABA0469AAAE6FD-jsch.agentproxy.pageant-0.0.5.jar libs.jsch.agentproxy/external/jsch.agentproxy.pageant-0.0.5.jar || die
	ln -s "${DISTDIR}"/8C05A1E3FE1BD4DC07F12E7BCF197118B29FB58E-jsch.agentproxy.usocket-nc-0.0.5.jar libs.jsch.agentproxy/external/jsch.agentproxy.usocket-nc-0.0.5.jar || die
	ln -s "${DISTDIR}"/F3885B903DC60BFD657520250788137D318B7B3C-jsch.agentproxy.usocket-jna-0.0.5.jar libs.jsch.agentproxy/external/jsch.agentproxy.usocket-jna-0.0.5.jar || die
	ln -s "${DISTDIR}"/2E07375E5CA3A452472F0E87FB33F243F7A5C08C-libpam4j-1.1.jar extexecution.impl/external/libpam4j-1.1.jar || die
	ln -s "${DISTDIR}"/3B181A2D228F92CA0531D3AB03E759D742B913D5-nashorn-02f810c26ff9-patched.jar libs.nashorn/external/nashorn-02f810c26ff9-patched.jar || die
	...
	ln -s "${DISTDIR}"/0CB932CDAD1898C52A0B11FFF854BB3CD8C46A30-org.eclipse.mylyn.wikitext.confluence.core_1.7.1.v20120725-0100.jar o.eclipse.mylyn.wikitext.confluence.core/external/org.eclipse.mylyn.wikitext.confluence.core_1.7.1.v20120725-0100.jar || die
	ln -s "${DISTDIR}"/AEA3D94B08D44DEB6556DCC93F7568D6C2E8A686-org.eclipse.mylyn.wikitext.core_1.7.1.v20120725-0100.jar o.eclipse.mylyn.wikitext.core/external/org.eclipse.mylyn.wikitext.core_1.7.1.v20120725-0100.jar || die
	ln -s "${DISTDIR}"/3B144D023541891D063C1DACA5980FA56918191B-org.eclipse.mylyn.wikitext.textile.core_1.7.1.v20120725-0100.jar o.eclipse.mylyn.wikitext.textile.core/external/org.eclipse.mylyn.wikitext.textile.core_1.7.1.v20120725-0100.jar || die
...
src_prepare() {
	...
	epatch netbeans-9999-r10-build.xml.patch
