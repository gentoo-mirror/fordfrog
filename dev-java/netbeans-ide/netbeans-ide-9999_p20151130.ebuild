...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2015-11-30_00-02-04/zip/netbeans-trunk-nightly-201511300002-src.zip"
SRC_URI="${SOURCE_URL}
...
src_prepare() {
	...
	java-pkg_jar-from --into docker.api/external bcpkix-1.52 bcpkix.jar bcpkix-jdk15on-153.jar
	java-pkg_jar-from --into docker.api/external bcprov-1.52 bcprov.jar bcprov-jdk15on-153.jar
...
src_install() {
	...
	pushd "${D}"/${instdir} >/dev/null || die
	rm bcpkix-jdk15on-153.jar && dosym /usr/share/bcpkix-1.52/lib/bcpkix.jar ${instdir}/bcpkix-jdk15on-153.jar || die
	rm bcprov-jdk15on-153.jar && dosym /usr/share/bcprov-1.52/lib/bcprov.jar ${instdir}/bcprov-jdk15on-153.jar || die
