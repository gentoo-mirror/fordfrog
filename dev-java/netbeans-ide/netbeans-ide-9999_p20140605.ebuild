...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2014-06-05_00-01-40/zip/netbeans-trunk-nightly-201406050001-src.zip"
SRC_URI="${SOURCE_URL}
	http://dev.gentoo.org/~fordfrog/distfiles/netbeans-9999-r13-build.xml.patch.bz2
...
src_unpack() {
	...
	unpack netbeans-9999-r13-build.xml.patch.bz2
...
src_prepare() {
	...
	epatch netbeans-9999-r13-build.xml.patch
