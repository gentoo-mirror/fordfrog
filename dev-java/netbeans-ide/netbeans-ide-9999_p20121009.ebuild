...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2012-10-09_00-02-25/zip/netbeans-trunk-nightly-201210090002-src.zip"
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/9EF021407512C855D7A12A8A7402A983C91C28F6-glassfish-tooling-sdk-0.3-b007.jar
	...
	http://hg.netbeans.org/binaries/CEA4354339310D955C15A39AAD4A9F106763164A-nashorn.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/9EF021407512C855D7A12A8A7402A983C91C28F6-glassfish-tooling-sdk-0.3-b007.jar libs.glassfish.sdk/external/glassfish-tooling-sdk-0.3-b007.jar || die
	...
	ln -s "${DISTDIR}"/CEA4354339310D955C15A39AAD4A9F106763164A-nashorn.jar libs.nashorn/external/nashorn.jar || die
