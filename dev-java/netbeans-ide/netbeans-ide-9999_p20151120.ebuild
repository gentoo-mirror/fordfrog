...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2015-11-20_00-02-04/zip/netbeans-trunk-nightly-201511200002-src.zip"
SRC_URI="${SOURCE_URL}
...
src_prepare() {
	...
	java-pkg_jar-from --into docker/external bcpkix-1.52 bcpkix.jar bcpkix-jdk15on-153.jar
	java-pkg_jar-from --into docker/external bcprov-1.52 bcprov.jar bcprov-jdk15on-153.jar
