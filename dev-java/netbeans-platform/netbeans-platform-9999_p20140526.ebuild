...
src_prepare() {
	...
	java-pkg_jar-from --into libs.jna.platform/external jna platform.jar jna-platform-4.0.0.jar
	java-pkg_jar-from --into javahelp/external javahelp jhall.jar jhall-2.0_05.jar
	java-pkg_jar-from --into libs.jna/external jna jna.jar jna-4.0.0.jar
...
src_install() {
	...
	rm jna-4.0.0.jar && dosym /usr/share/jna/lib/jna.jar ${instdir}/jna-4.0.0.jar || die
	rm jna-platform-4.0.0.jar && dosym /usr/share/jna/lib/platform.jar ${instdir}/jna-platform-4.0.0.jar || die
