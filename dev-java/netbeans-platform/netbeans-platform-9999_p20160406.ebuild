...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2016-04-06_00-01-48/zip/netbeans-trunk-nightly-201604060001-src.zip"
SRC_URI="${SOURCE_URL}
...
src_install() {
	...
	rm jna-platform-4.2.2.jar && java-pkg_jar-from --into "${instdir}" jna platform.jar jna-4.2.2.jar
