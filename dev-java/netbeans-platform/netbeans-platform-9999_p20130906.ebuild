...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2013-09-06_00-01-50/zip/netbeans-trunk-nightly-201309060001-src.zip"
SRC_URI="${SOURCE_URL}
	http://dev.gentoo.org/~fordfrog/distfiles/netbeans-9999-r11-build.xml.patch.bz2
...
src_unpack() {
	...
	unpack netbeans-9999-r11-build.xml.patch.bz2
...
src_prepare() {
	...
	epatch netbeans-9999-r11-build.xml.patch
