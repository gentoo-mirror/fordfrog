...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/26EAFE43113A32B19DC1646516ADB705729EEEEF-cdnjs.zip
	...
	http://hg.netbeans.org/binaries/4C234D697BD5F5CA749C725718EE5397DA112EEF-libiDeviceNativeBinding.dylib
	http://hg.netbeans.org/binaries/A3B3019678C47632C649E1EC62E64A9DA47603F1-libimobiledevice.4.dylib
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/26EAFE43113A32B19DC1646516ADB705729EEEEF-cdnjs.zip web.clientproject.api/external/cdnjs.zip || die
	...
	ln -s "${DISTDIR}"/4C234D697BD5F5CA749C725718EE5397DA112EEF-libiDeviceNativeBinding.dylib cordova.platforms.ios/external/libiDeviceNativeBinding.dylib || die
	ln -s "${DISTDIR}"/A3B3019678C47632C649E1EC62E64A9DA47603F1-libimobiledevice.4.dylib cordova.platforms.ios/external/libimobiledevice.4.dylib || die
