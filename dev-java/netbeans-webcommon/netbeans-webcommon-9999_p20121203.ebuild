...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/67D5E9D8908E25FC27029E9FD96E6A4834E5FCA5-libs.jstestdriver-ext.jar"
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/67D5E9D8908E25FC27029E9FD96E6A4834E5FCA5-libs.jstestdriver-ext.jar libs.jstestdriver/external/libs.jstestdriver-ext.jar || die
	popd >/dev/null || die
}
