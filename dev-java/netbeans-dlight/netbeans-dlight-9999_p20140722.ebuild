...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/593C2019938FEC2D02384B54C4A0A9272E384ADA-fs_server-1.0.zip"
...
src_unpack() {
	...
	unpack netbeans-9999-r14-build.xml.patch.bz2
        ...
        ln -s "${DISTDIR}"/593C2019938FEC2D02384B54C4A0A9272E384ADA-fs_server-1.0.zip dlight.remote.impl/external/fs_server-1.0.zip || die
        popd >/dev/null || die
}
