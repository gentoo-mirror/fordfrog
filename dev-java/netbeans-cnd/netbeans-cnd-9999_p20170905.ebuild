...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2017-09-05_12-53-23/zip/netbeans-trunk-nightly-201709051253-src.zip"
SRC_URI="${SOURCE_URL}
	https://dev.gentoo.org/~fordfrog/distfiles/netbeans-9999-r20-build.xml.patch.bz2
	...
	https://hg.netbeans.org/binaries/A672EE2C77CE98CBE5880C85AB6DF50D2D2B872D-clank_0.3.9.zip
...
src_unpack() {
	...
	unpack netbeans-9999-r20-build.xml.patch.bz2
	...
	ln -s "${DISTDIR}"/A672EE2C77CE98CBE5880C85AB6DF50D2D2B872D-clank_0.3.9.zip libs.clank/external/clank_0.3.9.zip || die
...
src_prepare() {
	...
	epatch netbeans-9999-r20-build.xml.patch
