...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/7709770AD436E2A11991BFDEB04CD0DC4C7EAFEA-open-fortran-parser-0.7.1.2.zip"
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/7709770AD436E2A11991BFDEB04CD0DC4C7EAFEA-open-fortran-parser-0.7.1.2.zip cnd.modelimpl/external/open-fortran-parser-0.7.1.2.zip || die
	popd >/dev/null || die
}
