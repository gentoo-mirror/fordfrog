...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/D358DAFC4DDA73954A0BC9730F27BCBFE2583C45-open-fortran-parser-0.7.1.2.zip"
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/D358DAFC4DDA73954A0BC9730F27BCBFE2583C45-open-fortran-parser-0.7.1.2.zip cnd.modelimpl/external/open-fortran-parser-0.7.1.2.zip || die
	popd >/dev/null || die
}
