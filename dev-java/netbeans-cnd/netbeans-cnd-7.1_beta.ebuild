...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/1E18576780EB117E410E7A262453A99B01E55B02-antlr-3.1.3.jar
	...
	http://hg.netbeans.org/binaries/6FE2E3BB57DAEBD1555494818909F9664376DD6C-stringtemplate-3.2.jar"
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/1E18576780EB117E410E7A262453A99B01E55B02-antlr-3.1.3.jar libs.antlr3.devel/external/antlr-3.1.3.jar || die
	...
	ln -s "${DISTDIR}"/6FE2E3BB57DAEBD1555494818909F9664376DD6C-stringtemplate-3.2.jar libs.antlr3.devel/external/stringtemplate-3.2.jar || die
	popd >/dev/null || die
}
