...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2012-05-24_00-02-14/zip/netbeans-trunk-nightly-201205240002-src.zip"
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/31352E9E8EBD7699BE9E14B83AED20C0BC543A75-open-fortran-parser-0.7.1.2.zip"
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/31352E9E8EBD7699BE9E14B83AED20C0BC543A75-open-fortran-parser-0.7.1.2.zip cnd.modelimpl/external/open-fortran-parser-0.7.1.2.zip || die
	popd >/dev/null || die
}
