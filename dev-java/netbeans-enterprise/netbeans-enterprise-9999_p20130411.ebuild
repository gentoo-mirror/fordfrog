...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2013-04-11_23-01-24/zip/netbeans-trunk-nightly-201304112301-src.zip"
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/E761A5679BE145719432DD13774FC124E6DA1E16-el-impl.jar
	http://hg.netbeans.org/binaries/7E906C168B4FFB5B621BA76899D1EC3EC029F75A-glassfish-jspparser-4.0.jar
	http://hg.netbeans.org/binaries/D813E05A06B587CD0FE36B00442EAB03C1431AA9-glassfish-logging-2.0.jar
	http://hg.netbeans.org/binaries/1D05F6E782831685EBE247C84F78BDF3DC161983-glassfish-tooling-sdk-0.3-b044.jar
	...
	http://hg.netbeans.org/binaries/89DD3D51297493DFF8EA559D2B25C0F6CABD2B57-javaee-api-7.0.jar
	http://hg.netbeans.org/binaries/EBEC44255251E6D3B8DDBAF701F732DAF0238CBF-javaee-web-api-6.0.jar
	http://hg.netbeans.org/binaries/C3EB52A7BE575475FB1C69BCD3B6D6F694CC2BCF-javaee-web-api-7.0.jar
	http://hg.netbeans.org/binaries/1A73607005DC6122EA7D9D3B411EC008EDEC9CAE-javaee-doc-api.jar
	...
	http://hg.netbeans.org/binaries/9336A960FE7108B0A84FDAACD54A7A75E7CD84BA-jsf-2.2.zip
	...
	http://hg.netbeans.org/binaries/76E6B906294C3B4BE7AE7629E859D62FF94379E6-servlet3.1-jsp2.3-api.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/E761A5679BE145719432DD13774FC124E6DA1E16-el-impl.jar libs.elimpl/external/el-impl.jar || die
	ln -s "${DISTDIR}"/7E906C168B4FFB5B621BA76899D1EC3EC029F75A-glassfish-jspparser-4.0.jar web.jspparser/external/glassfish-jspparser-4.0.jar || die
	...
	ln -s "${DISTDIR}"/1D05F6E782831685EBE247C84F78BDF3DC161983-glassfish-tooling-sdk-0.3-b044.jar libs.glassfish.sdk/external/glassfish-tooling-sdk-0.3-b044.jar || die
	...
	ln -s "${DISTDIR}"/89DD3D51297493DFF8EA559D2B25C0F6CABD2B57-javaee-api-7.0.jar javaee7.api/external/javaee-api-7.0.jar || die
	...
	ln -s "${DISTDIR}"/C3EB52A7BE575475FB1C69BCD3B6D6F694CC2BCF-javaee-web-api-7.0.jar javaee7.api/external/javaee-web-api-7.0.jar || die
	ln -s "${DISTDIR}"/1A73607005DC6122EA7D9D3B411EC008EDEC9CAE-javaee-doc-api.jar j2ee.platform/external/javaee-doc-api.jar || die
	...
	ln -s "${DISTDIR}"/9336A960FE7108B0A84FDAACD54A7A75E7CD84BA-jsf-2.2.zip web.jsf20/external/jsf-2.2.zip || die
	...
	ln -s "${DISTDIR}"/76E6B906294C3B4BE7AE7629E859D62FF94379E6-servlet3.1-jsp2.3-api.jar servletjspapi/external/servlet3.1-jsp2.3-api.jar || die
