...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2012-04-22_04-00-16/zip/netbeans-trunk-nightly-201204220400-src.zip"
SRC_URI="${SOURCE_URL}
	http://dev.gentoo.org/~fordfrog/distfiles/netbeans-9999-r4-build.xml.patch.bz2
	...
	http://hg.netbeans.org/binaries/80D8D97D71D5C10DB86669DFCF267123157B458E-glassfish-jspparser-3.0.jar
	...
	http://hg.netbeans.org/binaries/5673213CF352D4D6193139DA618E4321A3BE1172-libs.oracle.cloud-ext.jar
...
src_unpack() {
	...
	unpack netbeans-9999-r4-build.xml.patch.bz2
	...
	ln -s "${DISTDIR}"/80D8D97D71D5C10DB86669DFCF267123157B458E-glassfish-jspparser-3.0.jar web.jspparser/external/glassfish-jspparser-3.0.jar || die
	...
	ln -s "${DISTDIR}"/5673213CF352D4D6193139DA618E4321A3BE1172-libs.oracle.cloud-ext.jar libs.oracle.cloud/external/libs.oracle.cloud-ext.jar || die
...
src_prepare() {
	...
	epatch netbeans-9999-r4-build.xml.patch
