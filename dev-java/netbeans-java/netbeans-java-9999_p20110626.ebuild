...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2011-06-26_06-00-32/zip/netbeans-trunk-nightly-201106260600-src.zip"
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/1E4BAF3553AE5691E81647D30ABE8FFFC250B59E-eclipselink-2.3.0.jar
	http://hg.netbeans.org/binaries/E9DCFD351C4A7EB6C172612C987752F715BF2E6B-eclipselink-jpa-modelgen-2.3.0.jar
	...
	http://hg.netbeans.org/binaries/89BFCE12CA01C7518739B5AC2C22A220B6B5510E-indexer-artifact-4.1.1.jar
	http://hg.netbeans.org/binaries/D1B67FE60F2FDD654FDAE0A84B300DDB72CBC209-indexer-core-4.1.1.jar
	http://hg.netbeans.org/binaries/ADD5DE96BF7F30DAA4EC41D70610CF72A16F58FD-javac-api-nb-7.0-b07.jar
	http://hg.netbeans.org/binaries/8FB21F7AAC2DEB6215D71F00DCE1FAE9107643A9-javac-impl-nb-7.0-b07.jar
	...
	http://hg.netbeans.org/binaries/9B2ACF67C1DADE48B9FDFC398F6848FDCD7454D9-org.eclipse.persistence.jpa.jpql_1.0.0.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/1E4BAF3553AE5691E81647D30ABE8FFFC250B59E-eclipselink-2.3.0.jar j2ee.eclipselink/external/eclipselink-2.3.0.jar || die
	ln -s "${DISTDIR}"/E9DCFD351C4A7EB6C172612C987752F715BF2E6B-eclipselink-jpa-modelgen-2.3.0.jar j2ee.eclipselinkmodelgen/external/eclipselink-jpa-modelgen-2.3.0.jar || die
	...
	ln -s "${DISTDIR}"/89BFCE12CA01C7518739B5AC2C22A220B6B5510E-indexer-artifact-4.1.1.jar maven.indexer/external/indexer-artifact-4.1.1.jar || die
	ln -s "${DISTDIR}"/D1B67FE60F2FDD654FDAE0A84B300DDB72CBC209-indexer-core-4.1.1.jar maven.indexer/external/indexer-core-4.1.1.jar || die
	...
	ln -s "${DISTDIR}"/8FB21F7AAC2DEB6215D71F00DCE1FAE9107643A9-javac-impl-nb-7.0-b07.jar libs.javacimpl/external/javac-impl-nb-7.0-b07.jar || die
	...
	ln -s "${DISTDIR}"/9B2ACF67C1DADE48B9FDFC398F6848FDCD7454D9-org.eclipse.persistence.jpa.jpql_1.0.0.jar j2ee.eclipselink/external/org.eclipse.persistence.jpa.jpql_1.0.0.jar || die
