...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/B7E9E307CB1EA7096E14A873DDAA29F4CF20122B-indexer-artifact-5.0.0.jar
	http://hg.netbeans.org/binaries/B3751EFFD504E6545F411D3372B73086A7F13E75-indexer-core-5.0.0.jar
	...
	http://hg.netbeans.org/binaries/444CE7B858D0CADBAE2074E643F0DFA489B3DE07-nb-javac-impl.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/B7E9E307CB1EA7096E14A873DDAA29F4CF20122B-indexer-artifact-5.0.0.jar maven.indexer/external/indexer-artifact-5.0.0.jar || die
	ln -s "${DISTDIR}"/B3751EFFD504E6545F411D3372B73086A7F13E75-indexer-core-5.0.0.jar maven.indexer/external/indexer-core-5.0.0.jar || die
	...
	ln -s "${DISTDIR}"/444CE7B858D0CADBAE2074E643F0DFA489B3DE07-nb-javac-impl.jar libs.javacimpl/external/nb-javac-impl.jar || die
