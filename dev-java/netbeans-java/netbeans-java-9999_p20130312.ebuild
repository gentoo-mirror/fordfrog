...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2013-03-12_23-00-39/zip/netbeans-trunk-nightly-201303122300-src.zip"
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/CFCB625EE68731C9BD391F4B4C93FF018B407FA5-eclipselink.jar
	...
	http://hg.netbeans.org/binaries/250EC7FFF2F14DED9FF09BB572BE32D46727DB24-nb-javac-impl.jar
	http://hg.netbeans.org/binaries/6C6620D59D19E3A88F12CE8390C6C08B93DC5883-org.eclipse.persistence.jpa.jpql_2.5.0.v20130226-e0971b1.jar
	http://hg.netbeans.org/binaries/E0E9E2C84C314AD148A2DE151F163E8E93248645-eclipselink-jpa-modelgen_2.5.0.v20130226-e0971b1.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/CFCB625EE68731C9BD391F4B4C93FF018B407FA5-eclipselink.jar j2ee.eclipselink/external/eclipselink.jar || die
	...
	ln -s "${DISTDIR}"/250EC7FFF2F14DED9FF09BB572BE32D46727DB24-nb-javac-impl.jar libs.javacimpl/external/nb-javac-impl.jar || die
	ln -s "${DISTDIR}"/6C6620D59D19E3A88F12CE8390C6C08B93DC5883-org.eclipse.persistence.jpa.jpql_2.5.0.v20130226-e0971b1.jar j2ee.eclipselink/external/org.eclipse.persistence.jpa.jpql_2.5.0.v20130226-e0971b1.jar || die
	ln -s "${DISTDIR}"/E0E9E2C84C314AD148A2DE151F163E8E93248645-eclipselink-jpa-modelgen_2.5.0.v20130226-e0971b1.jar j2ee.eclipselinkmodelgen/external/eclipselink-jpa-modelgen_2.5.0.v20130226-e0971b1.jar || die
