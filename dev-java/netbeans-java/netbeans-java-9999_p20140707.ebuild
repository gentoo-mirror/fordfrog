...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/011FB635E6C482AB37BB82048F90858C6BB35070-hibernate-release-4.2.14-lib.zip
	...
	http://hg.netbeans.org/binaries/A30E0305F8EEB7FF6710AA93B984A248EC17FA1A-nb-javac-impl.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/011FB635E6C482AB37BB82048F90858C6BB35070-hibernate-release-4.2.14-lib.zip hibernate4lib/external/hibernate-release-4.2.14-lib.zip || die
	...
	ln -s "${DISTDIR}"/A30E0305F8EEB7FF6710AA93B984A248EC17FA1A-nb-javac-impl.jar libs.javacimpl/external/nb-javac-impl.jar || die
