...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2013-03-21_23-00-47/zip/netbeans-trunk-nightly-201303212300-src.zip"
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/D70A7697173BF9D0DBD8FCD2C0BEB1F6D2E86E10-eclipselink.jar
	...
	http://hg.netbeans.org/binaries/37CCACB467B117EDEF8E2EF9602B2203D820C1D0-javax.persistence_2.0.108.v201302191928.jar
	...
	http://hg.netbeans.org/binaries/B6A3DA7BFA5D28A66DF4CD224F4C2C17139A6E05-nb-javac-api.jar
	http://hg.netbeans.org/binaries/7AC092F7212E29045E0FDD433E72A348EC9CDF09-nb-javac-impl.jar
	http://hg.netbeans.org/binaries/9E48771381B1A7A3B357F619C1F017F31566D37B-org.eclipse.persistence.jpa.jpql_2.5.0.v20130312-9664d23.jar
	http://hg.netbeans.org/binaries/B8A18BDDBC1C585B3627CE1BD7B58392189936DD-eclipselink-jpa-modelgen_2.5.0.v20130312-9664d23.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/D70A7697173BF9D0DBD8FCD2C0BEB1F6D2E86E10-eclipselink.jar j2ee.eclipselink/external/eclipselink.jar || die
	...
	ln -s "${DISTDIR}"/37CCACB467B117EDEF8E2EF9602B2203D820C1D0-javax.persistence_2.0.108.v201302191928.jar j2ee.eclipselink/external/javax.persistence_2.0.108.v201302191928.jar || die
	...
	ln -s "${DISTDIR}"/B6A3DA7BFA5D28A66DF4CD224F4C2C17139A6E05-nb-javac-api.jar libs.javacapi/external/nb-javac-api.jar || die
	ln -s "${DISTDIR}"/7AC092F7212E29045E0FDD433E72A348EC9CDF09-nb-javac-impl.jar libs.javacimpl/external/nb-javac-impl.jar || die
	ln -s "${DISTDIR}"/9E48771381B1A7A3B357F619C1F017F31566D37B-org.eclipse.persistence.jpa.jpql_2.5.0.v20130312-9664d23.jar j2ee.eclipselink/external/org.eclipse.persistence.jpa.jpql_2.5.0.v20130312-9664d23.jar || die
	ln -s "${DISTDIR}"/B8A18BDDBC1C585B3627CE1BD7B58392189936DD-eclipselink-jpa-modelgen_2.5.0.v20130312-9664d23.jar j2ee.eclipselinkmodelgen/external/eclipselink-jpa-modelgen_2.5.0.v20130312-9664d23.jar || die
