...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2013-02-25_23-00-38/zip/netbeans-trunk-nightly-201302252300-src.zip"
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/21837CA918E13C634E296B66BD014571A249FDCA-eclipselink.jar
	...
	http://hg.netbeans.org/binaries/F971C66EEDAA38ADB3B0796F9DC40563AEFF3EB6-javax.persistence_2.0.107.v201302051125.jar
	...
	http://hg.netbeans.org/binaries/61DF70985835B2DF845DD0A5CB9BB750E5B8B24F-nb-javac-impl.jar
	http://hg.netbeans.org/binaries/05B4F00C6334D2313A89B5AE72D830CA00B6A71D-org.eclipse.persistence.jpa.jpql_2.5.0.v20130207-481ad60.jar
	http://hg.netbeans.org/binaries/CE7C82B8AD6D3E45C6DC6F5BCDFC5FFA2C6B5BA1-eclipselink-jpa-modelgen_2.5.0.v20130207-481ad60.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/21837CA918E13C634E296B66BD014571A249FDCA-eclipselink.jar j2ee.eclipselink/external/eclipselink.jar || die
	...
	ln -s "${DISTDIR}"/F971C66EEDAA38ADB3B0796F9DC40563AEFF3EB6-javax.persistence_2.0.107.v201302051125.jar j2ee.eclipselink/external/javax.persistence_2.0.107.v201302051125.jar || die
	...
	ln -s "${DISTDIR}"/61DF70985835B2DF845DD0A5CB9BB750E5B8B24F-nb-javac-impl.jar libs.javacimpl/external/nb-javac-impl.jar || die
	ln -s "${DISTDIR}"/05B4F00C6334D2313A89B5AE72D830CA00B6A71D-org.eclipse.persistence.jpa.jpql_2.5.0.v20130207-481ad60.jar j2ee.eclipselink/external/org.eclipse.persistence.jpa.jpql_2.5.0.v20130207-481ad60.jar || die
	ln -s "${DISTDIR}"/CE7C82B8AD6D3E45C6DC6F5BCDFC5FFA2C6B5BA1-eclipselink-jpa-modelgen_2.5.0.v20130207-481ad60.jar j2ee.eclipselinkmodelgen/external/eclipselink-jpa-modelgen_2.5.0.v20130207-481ad60.jar || die
