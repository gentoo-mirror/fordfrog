...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2012-05-01_04-00-16/zip/netbeans-trunk-nightly-201205010400-src.zip"
SRC_URI="${SOURCE_URL}
	http://dev.gentoo.org/~fordfrog/distfiles/netbeans-9999-r5-build.xml.patch.bz2
	...
	http://hg.netbeans.org/binaries/129BA6F4F1F7FA6A2D616D8C67F036DAFD16B851-nb-javac-impl.jar
...
src_unpack() {
	...
	unpack netbeans-9999-r5-build.xml.patch.bz2
	...
	ln -s "${DISTDIR}"/129BA6F4F1F7FA6A2D616D8C67F036DAFD16B851-nb-javac-impl.jar libs.javacimpl/external/nb-javac-impl.jar || die
...
src_prepare() {
	...
	epatch netbeans-9999-r5-build.xml.patch
