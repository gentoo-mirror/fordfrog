...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2011-12-18_06-00-36/zip/netbeans-trunk-nightly-201112180600-src.zip"
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/418D3D56EB9785CF0D6214AF82AB141C094A494D-apache-maven-3.0.4-RC3-bin.zip
	...
	http://hg.netbeans.org/binaries/481935A7F53B55502187BD3C28C2BC0D957BB643-eclipselink-jpa-modelgen-2.3.2.jar
	...
	http://hg.netbeans.org/binaries/08BE4512F27DACC7CCC49766F1383B6DD48393E2-javac-impl-nb-7.0-b07.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/418D3D56EB9785CF0D6214AF82AB141C094A494D-apache-maven-3.0.4-RC3-bin.zip maven.embedder/external/apache-maven-3.0.4-RC3-bin.zip || die
	...
	ln -s "${DISTDIR}"/481935A7F53B55502187BD3C28C2BC0D957BB643-eclipselink-jpa-modelgen-2.3.2.jar j2ee.eclipselinkmodelgen/external/eclipselink-jpa-modelgen-2.3.2.jar || die
	...
	ln -s "${DISTDIR}"/08BE4512F27DACC7CCC49766F1383B6DD48393E2-javac-impl-nb-7.0-b07.jar libs.javacimpl/external/javac-impl-nb-7.0-b07.jar || die
