...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/4A197478218CD61C1899A2033D45699F135AD511-eclipselink.jar
	...
	http://hg.netbeans.org/binaries/4A8143DFB98AC37B7D1EA016648944512AE4FA2F-javax.persistence_2.0.111.v201304031339.jar
	...
	http://hg.netbeans.org/binaries/EAEB34E03C2EF25ED0F4C29EF1CC929A523251E4-nb-javac-api.jar
	http://hg.netbeans.org/binaries/77BDA6CDFB0B0100E9530E5E61E758939B87B66E-nb-javac-impl.jar
	http://hg.netbeans.org/binaries/9BFD7F0DDFDEBA1278166A388D036EBB8378C9B0-org.eclipse.persistence.jpa.jpql_2.5.0.v20130403-740364a.jar
	http://hg.netbeans.org/binaries/A9452968A558AB80627C308446BD56F81F83300F-org.eclipse.persistence.jpa.modelgen_2.5.0.v20130403-740364a.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/4A197478218CD61C1899A2033D45699F135AD511-eclipselink.jar j2ee.eclipselink/external/eclipselink.jar || die
	...
	ln -s "${DISTDIR}"/4A8143DFB98AC37B7D1EA016648944512AE4FA2F-javax.persistence_2.0.111.v201304031339.jar j2ee.eclipselink/external/javax.persistence_2.0.111.v201304031339.jar || die
	...
	ln -s "${DISTDIR}"/EAEB34E03C2EF25ED0F4C29EF1CC929A523251E4-nb-javac-api.jar libs.javacapi/external/nb-javac-api.jar || die
	ln -s "${DISTDIR}"/77BDA6CDFB0B0100E9530E5E61E758939B87B66E-nb-javac-impl.jar libs.javacimpl/external/nb-javac-impl.jar || die
	ln -s "${DISTDIR}"/9BFD7F0DDFDEBA1278166A388D036EBB8378C9B0-org.eclipse.persistence.jpa.jpql_2.5.0.v20130403-740364a.jar j2ee.eclipselink/external/org.eclipse.persistence.jpa.jpql_2.5.0.v20130403-740364a.jar || die
	ln -s "${DISTDIR}"/A9452968A558AB80627C308446BD56F81F83300F-org.eclipse.persistence.jpa.modelgen_2.5.0.v20130403-740364a.jar j2ee.eclipselinkmodelgen/external/org.eclipse.persistence.jpa.modelgen_2.5.0.v20130403-740364a.jar || die
