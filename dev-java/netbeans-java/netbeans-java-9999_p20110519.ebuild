...
SLOT="9999"
SOURCE_URL="http://bits.netbeans.org/download/trunk/nightly/2011-05-19_04-00-16/zip/netbeans-trunk-nightly-201105190400-src.zip"
SRC_URI="${SOURCE_URL}
	http://dev.gentoo.org/~fordfrog/distfiles/netbeans-7.0-build.xml-r1.patch.bz2
	...
	http://hg.netbeans.org/binaries/D1C0B8741FF5E12926C700CFD934FDF046A49A4B-javac-impl-nb-7.0-b07.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/D1C0B8741FF5E12926C700CFD934FDF046A49A4B-javac-impl-nb-7.0-b07.jar libs.javacimpl/external/javac-impl-nb-7.0-b07.jar || die
